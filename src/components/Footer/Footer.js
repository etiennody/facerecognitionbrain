  ...
  return (
    <div>
      ...
      <footer className="pv4 ph3 tc">
        <a className="link near-black hover-silver dib mh3 tc" href="https://github.com/etiennody" title="GitHub" target="_blank" rel="noreferrer">
        ...
        <a className="link hover-silver near-black dib mh3 tc" href="https://www.linkedin.com/in/jody-etienne/" title="LinkedIn" target="_blank" rel="noreferrer">
        ...
        <a className="link hover-silver near-black dib mh3 tc" href="https://twitter.com/etiennody" title="Twitter" target="_blank" rel="noreferrer">
